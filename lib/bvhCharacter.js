    ...
    this.buildSkelBones = function(jointMesh) {
        ...
        jointMesh.children.forEach(function(childMesh) {
            // if (typeof childMesh.bvhIndex !== "undefined")
            {
                ...
                var bgeometry = self.makeBoneGeometryFCN(jointMesh.name, childMesh.name, h, self.skelScale);
                ...
                //bgeometry.translate(childMesh.parent.offsetVec.x / 2, childMesh.parent.offsetVec.y / 2, childMesh.parent.offsetVec.z / 2);
                ...
                bgeometry.translate(0, -childMesh.offsetVec.y / 2, 0);
                //END - Universal
